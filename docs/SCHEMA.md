...
This document describes the database models, tables, columns, and relationships defined in the Prisma schema file [schema.prisma](file:///c:/Users/ravi/Desktop/INBOX/InboxOS/backend/prisma/schema.prisma). InboxOS uses SQLite by default for local development, storing data at `apps/api/inboxos.db`.
